package com.moecheng.distributedcrawler.master.utils;
...
public class UrlUtils {
    ...
    public static List<URLRequest> convertToRequests(Collection<String> urls) {
        List<URLRequest> URLRequestList = new ArrayList<URLRequest>(urls.size());
        for (String url : urls) {
            URLRequestList.add(new URLRequest(url));
        }
        return URLRequestList;
    }

    public static List<String> convertToUrls(Collection<URLRequest> URLRequests) {
        List<String> urlList = new ArrayList<String>(URLRequests.size());
        for (URLRequest URLRequest : URLRequests) {
            urlList.add(URLRequest.getUrl());
        }
        return urlList;
    }
