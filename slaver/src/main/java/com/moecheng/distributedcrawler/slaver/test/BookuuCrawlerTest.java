...
import com.moecheng.distributedcrawler.slaver.Crawler;
 ...
 */
public class BookuuCrawlerTest implements Processor {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Crawler.create(new BookuuCrawlerTest()).addUrl("http://www.bookuu.com/").setThread(threadNum).addPipeline(new BookInfoPipeline()).run();
    }
}
